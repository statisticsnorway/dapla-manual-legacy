...
Enhver endring som er gjort skal være sporbare og dokumentert slik at statistikkene skal være etterprøvbare. Klargjorte date er som regel *ikke* aggregerte - med mindre dataen vi mottar er aggregert. Med andre ord inneholder klargjorte data fortsatt enkeltobservasjoner [@datatilstander2 pp. 9]. Klargjorte data lagres i bøtten `ssb-prod-<teamnavn>-data-produkt`.
