...
- Hvilken tilgang du søker om. Typisk er det enten *data-admins*, *developers* eller *consumers* (nevnt mer om under). [Les mer om hva de ulike tilgangene innebærer her](./hva-er-dapla-team.html#tbl-tilgangsroller). 
...
### Tilgang til andre Dapla-team sine delte data

Når du skal ha tilgang til et annet teams data er søknadsprosessen den samme som å legge til eller fjerne medlemmer i team slik som nevnt over. Det som er annerledes er at det er i det teamet du skal ha dataene fra sin *consumers* gruppe du skal søke om å legges inn i inn. Gjennomføres på følgende måte med sak til Kundeservice:

- Navnet på Dapla-teamet du ønsker tilgang til sine delte data
- Om det er du eller hele teamet ditt som søker tilgangen (ditt teams *developers* for eksempel)
- Beskrivelse av formålet med tilgangen

Samme her at endringer i team må godkjennes av søkers seksjonsleder før de blir effektuert. Viktig å merke seg at det er søkers seksjonsleder som skal godkjenne tilgang til et annet teams *consumers* gruppe i tråd med @tilgangsstyring.

## Se medlemmer og roller i et team

For å se hvem som har de ulike tilgangsrollene i et team, så må man sende en henvendelse til Kundeservice. 
