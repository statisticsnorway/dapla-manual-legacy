...
Hvis du skal overføre data fra bakken/prodsonen til sky, så må de med **data-admins**-rollen skrive ut data til Linux-mappen `/ssb/cloud_sync/<team navn>/data/tilsky`, og det vil ende opp i Dapla-bøtta `gs://ssb-prod-<team navn>-data-synk-opp` Dette kan du gjøre med alle programmeringsverktøy som har en kobling til Linux-stammene der dataene ligger. For eksempel:
...
Skal du flytte data fra Dapla til bakken/prodsonen, så må **data-admins** skrive ut data til `gs://ssb-prod-<team navn>-data-synk-opp`-bøtta på Dapla. Det er noe man typisk gjør fra **Jupyterlab** på Dapla. 
