...
jupyter:
  ...
  kernelspec:
    display_name: hack2023-daplahub
    language: python
    name: hack2023-daplahub
---
...
I vedlagt finner du blant annet eksempler på hvordan du legger til din egen metadata i en Delta Lake Table.
