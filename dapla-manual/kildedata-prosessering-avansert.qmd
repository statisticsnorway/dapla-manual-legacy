...
1. Du har nå komme frem til loggene, se etter indikasjoner på feil. I eksemplet under ser vi at testen test_main_accepts_expected_number_of_args feiler fordi `process_source_data.py` mangler en main funksjon. ![Cloud Run logg](images/fail-pr-tests-log-step3.png){fig-alt="Cloud Run logg"}
