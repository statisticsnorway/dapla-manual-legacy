...
**VIKTIG:** DataDoc kan foreløpig ikke kjøres i Jupyter notebook med virtuelle miljøer (*ssb-project/virtuelt miljø*), men **må startes i en"Python 3 (ipykernal)" notebook**.
