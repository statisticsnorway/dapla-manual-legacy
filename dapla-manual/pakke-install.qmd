...
## Python 
Installering av pakker er kun er mulig I et [virtuelt miljø](virtual-env.qmd). Det er [anbefalt å benytte poetry](virtual-env.qmd#Anbefalning) til dette. Eksemplene videre benytter derfor poetry.

Det er mulig å [installere pakker uten poetry](https://packaging.python.org/en/latest/guides/installing-using-pip-and-virtual-environments/). Pakker kan installeres som normalt, hvis man har satt opp og aktivert et [virtuelt miljø](virtual-env.qmd). 

### Poetry prosjekt eksempel 
I dette eksemplet heter prosjektet test, hvis man ønsker å benytte et annet prosjektnavn må man endre dette i hver av kommandoene. 
...
Hvem som helst kan legge til pakker på PyPi, det betyr at de i verstefall, kan inneholde skadelig kode. Her er tips til noen grep man kan ta for å minimere risikoen:  
