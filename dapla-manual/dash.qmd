...
For mer om håndtering av pakker i ett virtuelt miljø satt opp med ssb-project kan man se nærmere [her](./pakke-install.html). For å legge til disse pakkene kan man gjøre følgende i terminalen:
