...
::: {.callout-note}
I dette kapitlet vil vi ofte vise bilder fra [Google Cloud Console (GCC)](https://console.cloud.google.com/). Det er et svært nyttig verktøy for å bli kjent med ressursene som er tilgjengelig for et Dapla-team i på Dapla. Hvordan du bruker GCC er nærmere forklart [i et annet kapittel](./gcc.html). 
:::
...
**data-admin** har i tillegg til lagringsområdene på sky, tilgang til mappen den mappen på bakken: `/ssb/cloud_sync/arbmark-skjema`. Her kan de legge filer som de ønsker å flytte til skyen.
...
| arbmark-skjema-synk-opp         | X          | X         |          |
| arbmark-skjema-synk-ned         | X          | X         |          |
