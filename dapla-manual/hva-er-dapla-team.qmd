...
Dapla-team er et begrep som brukes på Dapla for å beskrive en gruppe personer som jobber med et eller flere emneområder på Dapla. Hvert Dapla-team har et eget prosjektområde i Google Cloud Platform (GCP), som er SSBs leverandør av skytjenester. 

Når man oppretter et Dapla-team i SSB får man følgende: 

- Lagringsområde for data i Google Cloud Storage (GCS)
...
Når man oppretter et Dapla-team får man tilgang til en del tjenester som blir ferdig satt opp for oss. Det er viktig å forstå hva disse tjenestene er, og hvordan de kan brukes.
