...
boliger_med_butikkinfo = boliger.sjoin_nearest(butikker, distance_col="meter_til_butikk")
```
...
veger = read_SSB("ssb-prod-dapla-felles-data-delt/GIS/testdata/veger_oslo.parquet")
```
