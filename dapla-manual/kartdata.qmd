...
Se eksempler på nettverksanalyse i [GISSB-pakken](https://statisticsnorway.github.io/GISSB/articles/GISSB_vignette.html).

Eksempel på kobling basert geografisk sammenfall (enkle kommuner er egentlig til visualisering):
...
```R
kommuner_med_boliginfo = st_join(enkle_kommuner, boliger)
```