...
2. Trykk på Jupyterlab-ikonet, som vist på @jupyter-icon, og logg deg inn med vanlig brukernavn og passord.

![Jupyterlab-ikon på Skrivebordet i Citrix-Windows.](./images/citrix_jupyter_icon.png){ fig-alt="Bildet som viser hvordan man åpner Jupyterlab-miljet på bakken." width=75% #jupyter-icon }
