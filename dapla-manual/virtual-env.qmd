...
## Python
Et python viretuelt miljø inneholder en spesifikk versjon av python og et sett med pakker. Pakkene er kun tilgjengelige når det viretuelt miljøet er aktivert. Dette gjør at man ungår avhengighetskonflikter på tvers av prosjekter.

Se her for [mer informasjon om viretuelle miljøer.](https://docs.python.org/3/tutorial/venv.html)
