...
![Dialogboks som åpnes når 2FA skrus på første gang.](images/github_2fa_enable.JPG){ fig-alt="Bilde av GitHub-dialogboks for å skru på 2-faktor autentifisering." #fig-github-enable-2fa }

5. @fig-github-2fa-app viser dialogboksen som vises for å velge hvordan man skal autentifisere seg. Her anbefales det å velge **Set up using an app**, slik at du kan bruke *Microsoft Authenticator*-appen på din mobil. 

![Dialogboks for å velge hvordan man skal autentifisere seg med 2FA.](images/githbu_2fa_app.JPG){ fig-alt="Bilde av GitHub-dialogboks for å velge hvordan man skal autentifisere seg med 2-faktor autentifisering." #fig-github-2fa-app }

@fig-github-QR viser QR-koden som vises. Denne skal vi bruke i neste steg.

![QR-kode som skannes av Microsoft Authenticator.](images/github_2fa.png){ fig-alt="Bilde av GitHub-dialogboks for å velge hvordan man skal autentifisere seg med 2-faktor autentifisering." #fig-github-QR }
...
::: {.g-col-4}
![Mobilappen *Microsoft authenticator*](images/authenticator.jpg){ fig-alt="Bilde av GitHub-dialogboks for å velge hvordan man skal autentifisere seg med 2-faktor autentifisering." #fig-authenticator width=50% }
