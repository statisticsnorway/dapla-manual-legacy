...
2. Hvis du ønsker at **ssb-project** også skal opprette et GitHub-repo for deg må du også følgende være på plass:
    ...
    b. Skru på **2-faktor autentifisering** for GitHub-brukeren din ([les hvordan her](git-github.html#sec-tofaktor))
    c. Være koblet mot SSBs organisasjon [statisticsnorway](https://github.com/statisticsnorway) på GitHub ([les hvordan her](git-github.html#koble-deg-til-ssb))
